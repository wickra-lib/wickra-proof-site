...
- GitHub → the [wickra-proof repository](https://github.com/wickra-lib/wickra-proof)
...
Wickra Proof parses untrusted `ScanSpec` JSON and candle data, so its parser and
...
[SECURITY.md](https://github.com/wickra-lib/wickra-proof/blob/main/SECURITY.md)
