...
const structuredData = {
  ...
  '@graph': [
    {
      '@type': 'Organization',
      '@id': 'https://proof.wickra.org/#organization',
      name: 'Wickra',
      url: 'https://proof.wickra.org/',
      logo: 'https://proof.wickra.org/wickra-mark.svg',
      sameAs: [
        'https://github.com/wickra-lib/wickra-proof',
    ...
    },
    {
      ...
      '@id': 'https://proof.wickra.org/#software',
      name: 'Wickra Proof',
      url: 'https://proof.wickra.org/',
      ...
      description:
        'Proof-of-Backtest: a deterministic report plus a canonical blake3 hash from a (spec, data) pair, recomputable byte-for-byte in ten languages.',
      license: 'https://github.com/wickra-lib/wickra-proof#license',
      publisher: { '@id': 'https://proof.wickra.org/#organization' },
    },
  ],
}
...
export default defineConfig({
  ...
  // Served at the domain root (proof.wickra.org via Cloudflare Pages).
  base: '/',

  sitemap: { hostname: 'https://proof.wickra.org' },
  ...
  head: [
    ...
    ['meta', { property: 'og:title', content: 'Wickra Proof — a backtest report anyone can recompute byte-for-byte' }],
    [
      'meta',
      {
    ...
    ['meta', { property: 'og:image', content: 'https://proof.wickra.org/og-banner.webp' }],
    ['meta', { name: 'twitter:card', content: 'summary_large_image' }],
    ['meta', { name: 'twitter:image', content: 'https://proof.wickra.org/og-banner.webp' }],
    ['script', { type: 'application/ld+json' }, JSON.stringify(structuredData)],
  ],

  transformPageData(pageData) {
    const path = pageData.relativePath.replace(/(?:index)?\.md$/, '')
    const canonical = `https://proof.wickra.org/${path}`
  ...
  themeConfig: {
    siteTitle: 'Wickra Proof',
    logo: { src: '/wickra-mark.svg', alt: 'Wickra Proof' },
    ...
    nav: [
      ...
      { text: 'GitHub', link: 'https://github.com/wickra-lib/wickra-proof' },
      {
        text: 'Links',
        items: [
          { text: 'crates.io', link: 'https://crates.io/crates/wickra-proof-core' },
          { text: 'PyPI', link: 'https://pypi.org/project/wickra-proof/' },
          { text: 'npm', link: 'https://www.npmjs.com/package/wickra-proof' },
          { text: 'NuGet', link: 'https://www.nuget.org/packages/Wickra.Proof' },
          { text: 'Maven Central', link: 'https://central.sonatype.com/artifact/org.wickra/wickra-proof' },
          { text: 'Go module', link: 'https://pkg.go.dev/github.com/wickra-lib/wickra-proof-go' },
      ...
      },
      {
        text: 'v0.1.4',
        items: [
          { text: 'Release notes', link: 'https://github.com/wickra-lib/wickra-proof/releases' },
          { text: 'Changelog', link: 'https://github.com/wickra-lib/wickra-proof/blob/main/CHANGELOG.md' },
          { text: 'docs.rs', link: 'https://docs.rs/wickra-proof-core/latest/wickra_proof_core/' },
        ],
      },
      {
        text: 'Ecosystem',
    ...
    socialLinks: [{ icon: 'github', link: 'https://github.com/wickra-lib/wickra-proof' }],
