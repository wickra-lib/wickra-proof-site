 ...
 * shields.io and are best-effort (wickra-proof is not published yet, so they
...
const PROFILE = 'https://raw.githubusercontent.com/wickra-lib/.github/main/profile/badges/wickra-proof'

// Source of truth for the footer badge row. Mirrors the wickra-proof README.
const badges = [
  { alt: 'CI', slug: 'ci', src: `${PROFILE}/ci.svg`, href: 'https://github.com/wickra-lib/wickra-proof/actions/workflows/ci.yml' },
  { alt: 'CodeQL', slug: 'codeql', src: `${PROFILE}/codeql.svg`, href: 'https://github.com/wickra-lib/wickra-proof/actions/workflows/codeql.yml' },
  { alt: 'codecov', slug: 'codecov', src: `${PROFILE}/codecov.svg`, href: 'https://codecov.io/gh/wickra-lib/wickra-proof' },
  { alt: 'GitHub release', slug: 'release', src: 'https://img.shields.io/github/v/release/wickra-lib/wickra-proof?logo=github&color=green', href: 'https://github.com/wickra-lib/wickra-proof/releases/latest' },
  { alt: 'crates.io', slug: 'crates', src: 'https://img.shields.io/crates/v/wickra-proof.svg?logo=rust&color=orange', href: 'https://crates.io/crates/wickra-proof' },
  { alt: 'PyPI', slug: 'pypi', src: 'https://img.shields.io/pypi/v/wickra-proof.svg?logo=pypi&color=blue', href: 'https://pypi.org/project/wickra-proof/' },
  { alt: 'npm', slug: 'npm', src: 'https://img.shields.io/npm/v/wickra-proof.svg?logo=npm&color=red', href: 'https://www.npmjs.com/package/wickra-proof' },
  { alt: 'NuGet', slug: 'nuget', src: 'https://img.shields.io/nuget/v/Wickra.Proof.svg?logo=nuget&color=blue', href: 'https://www.nuget.org/packages/Wickra.Proof' },
  { alt: 'Maven Central', slug: 'maven', src: 'https://img.shields.io/maven-central/v/org.wickra/wickra-proof.svg?logo=apachemaven&color=blue', href: 'https://central.sonatype.com/artifact/org.wickra/wickra-proof' },
  { alt: 'Go module', slug: 'go', src: 'https://img.shields.io/github/v/tag/wickra-lib/wickra-proof-go.svg?logo=go&logoColor=white&color=00ADD8&label=go', href: 'https://pkg.go.dev/github.com/wickra-lib/wickra-proof-go' },
  { alt: 'r-universe', slug: 'r-universe', src: 'https://wickra-lib.r-universe.dev/badges/wickra-proof', href: 'https://wickra-lib.r-universe.dev' },
  { alt: 'License: MIT OR Apache-2.0', slug: 'license', src: `${PROFILE}/license.svg`, href: 'https://github.com/wickra-lib/wickra-proof#license' },
  { alt: 'OpenSSF Scorecard', slug: 'scorecard', src: `${PROFILE}/scorecard.svg`, href: 'https://scorecard.dev/viewer/?uri=github.com/wickra-lib/wickra-proof' },
  { alt: 'OpenSSF Best Practices', slug: 'best-practices', src: `${PROFILE}/best-practices.svg`, href: 'https://www.bestpractices.dev/' },
  { alt: 'Build provenance', slug: 'provenance', src: `${PROFILE}/provenance.svg`, href: 'https://github.com/wickra-lib/wickra-proof/attestations' },
  { alt: 'Verified across 10 languages', slug: 'verified', src: `${PROFILE}/verified.svg`, href: 'https://github.com/wickra-lib/wickra-proof/tree/main/golden' },
]
...
for (const b of badges) {
  try {
    if (b.slug === 'release') {
      const v = (await ghJson('repos/wickra-lib/wickra-proof/releases/latest')).tag_name
      b.src = `https://img.shields.io/badge/release-${escBadge(v)}-green?logo=github`
    } else if (b.slug === 'go') {
      const v = (await ghJson('repos/wickra-lib/wickra-proof-go/tags'))[0]?.name
